...
const Input = () => {
  return (
      ...
      <form action="">
        <div className='border-2 border-emarald-500 text-white flex flex-col gap-1 w-[360px] p-3'>
            <div className='flex'>
                <div className=""></div>
                <h1 className="text-white text-4xl font-bold">create task</h1>
            </div>
            <h1 className='text-xl'>Task Title</h1>
            <input className="p-2 border-2 rounded" type="text" placeholder="make a ui design" />
            <h1 className="font-semibold">describtion</h1>
            <textarea className=" border-2 rounded h-[70px]" placeholder="description"></textarea>
            <h1>date</h1>
